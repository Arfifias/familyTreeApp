...
public class FamilySearch {
    ...
    public static void FamilyToFind() {
       Scanner family = new Scanner(System.in);//Input
        System.out.print("Give the first name: ");
        String first = family.nextLine();//Inserting the first name
        System.out.print("Give the second name: ");
        String second = family.nextLine();//Inserting second name
        
        System.out.println("\n\n Family Realationship.");
	System.out.println("<==============================>");
        System.out.println();//Useful variable
        ...
        //Calling all methods and giving the variables of the methods
        ...
        while(!result){
            ...
            //Checking the relationship between all family members
    ...
    public static String Parents(String f,String s){
        ...
        String first = f;
        String second = s;//Method variables
        String ret = "";//The relathionship variable which is being returned
        ...
        return ret;//Returnung the relationship

    }
    
    public static String Couple(String f,String s){
        String first = f;
        String second = s;//Variables
        String ret = "";//Returning relation
        ...
        return ret;//Returning the relation 
    ...
    public static String Grandparents(String f,String s){
         ...
         return ret;//Returning relation

    }
    
    public static String UncleandAunt(String f,String s){
             String first = f;
             String second = s;//Vatiables
             String ret = "";//Relation
    ...
    public static String NoRelation(String f,String s){
        String first = f;
        String second = s;//Variables
        String ret = "No relation";//Checking for no relation

        if("".equals(first) || "".equals(second)){
            ret = "Name not Found";
            //If the variables are not equal the relation does not exists
        }
